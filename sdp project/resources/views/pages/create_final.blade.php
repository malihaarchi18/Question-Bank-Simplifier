...
@guest
 ...
 @else
<div class="qu">
     <h2 style="color:white;"> Create Term Final Question</h2>
</div><br><br>
@if(session('msg'))
...
<form action="{{ route('create.termfinal') }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
  <div class="form-row">
   ...
   <div class="form-row">
    ...
    <div class="form-group col-md-4"  style="margin-left: 200px ;">
      <label for="inputPassword4">Total Question</label>
      <input type="number" class="form-control" name="q" id="inputPassword4" autocomplete="off" max="20" placeholder="No. of Question Set">
    </div>
  </div>

   <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputEmail4">Number of subset in each question</label>
        <select id="inputState" name="set" class="form-control">
    ...
    <div class="form-group col-md-4" style="margin-left: 200px ;">
      ...
      <input type=text class="form-control" name="time" id="inputEmail4" max="180" placeholder="Total time" autocomplete="off">
    </div>
  </div>

...
<form action="{{ route('course') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-row">
    ...
    <div class="col-sm-4">
      <input type="text" name="title" class="form-control" id="colFormLabel" placeholder="" autocomplete="off">
    </div>
  </div>
<br><br>
  <div class="form-row">
    ...
    <div class="col-sm-4">
      <input type="text" name="code" class="form-control" id="colFormLabel" placeholder="" autocomplete="off">
    </div>
  </div>
   <button type="submit" class="qstore">Add Course</button>
</form>
